...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='/home/mgali/Desktop/dataset/val/fields/1.jpeg',
                        help='path to image to predict')
    parser.add_argument('--model_path', type=str, default='checkpoints/v2/best_v2_model.h5',
