...
def train_model(input_shape, alpha, gamma, learning_rate, data_path, epochs, model_name):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/mgali/Desktop/dataset',
